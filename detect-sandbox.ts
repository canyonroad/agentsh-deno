 ...
 * the Deno sandbox running agentsh v0.16.9.
 *
 * Checks:
 ...
 *   4. real_paths and BASH_ENV -- verify v0.16.9 features are active
...
async function main(): Promise<void> {
  ...
  try {
    ...
    // =====================================================================
    // 3f. v0.16.9 features: real_paths mode and BASH_ENV injection
    // =====================================================================
    banner("3f. v0.16.9 features (real_paths, BASH_ENV)");
